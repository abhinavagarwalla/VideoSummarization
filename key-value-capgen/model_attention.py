    ...
    def lstm_cond_layer(self, tparams, state_below, options, prefix='lstm',
        ...
        if options['use_dropout']:
            _step0 = lambda m_, x_, dp_, h_, c_, \
                a_, ct_, \
                pctx_, context, value, Wd_att, U_att, c_att, W_sel, b_sel, U, Wc: _step(
                m_, x_, h_, c_,
                a_, ct_,
            ...
            _step0 = lambda m_, x_, h_, c_, \
                a_, ct_, pctx_, context, value, Wd_att, U_att, c_att, W_sel, b_sel, U, Wc: _step(
        ...
        if one_step:
            if options['use_dropout']:
                rval = _step0(
                    ...
                    pctx_, context, value, Wd_att, U_att, c_att, W_sel, b_sel, U, Wc)
            else:
